package org.employee.service.consumer;
...
@Configuration
public class ServiceConfigConsumer {
    ...
    public AbstractMessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory) {
        ...
        messageListenerContainer.setQueueNames("rabbitMQEmployee");
    ...
    /**
     * A transformer that converts string containing JSON to an {@link Employee} object.
     * <p>
     ...
     */
    @Bean
    @Transformer(inputChannel = "fromRabbit", outputChannel = "queue")
    public JsonToObjectTransformer jsonToObjectTransformer() {
        return new JsonToObjectTransformer(Employee.class);
    }

    @Bean
    public MessageChannel queue() {
        return new DirectChannel();
    }
}
