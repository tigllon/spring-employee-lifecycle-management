package org.employee.service.publisher;
...
@Configuration
public class ServiceConfigPublisher {
    @Bean
     ...
     */
    @Bean
    @Transformer(inputChannel = "publish", outputChannel = "toRabbit")
    ...
    public AmqpOutboundEndpoint rabbitOutboundEndpoint(AmqpTemplate amqpTemplate) {
        ...
        adapter.setRoutingKey("rabbitMQEmployeeOutput");
        return adapter;
    }
}
